...
#' @param boxPlotJitter, Displays the individual observations as points, jittered horizontally to reduce overlap; their vertical position is unchanged, so each point still shows its exact value.
#'    Defaults to \code{FALSE}.
