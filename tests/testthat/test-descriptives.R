...
test_that("Analysis handles identical variables", {
  ...
  jaspTools::expect_equal_tables(table,
                      list(-1.19915675837133, 1, 1.007309698, -0.33853731055, -1.625143884,
                           ...
                           "contNormal", 0, 0, 0, 0, "NaN", 1, 12.3, 12.3, 12.3, 0, "",
                           "", "NaN", 0, 0.992383612541845, 0.512103336707757, 20, "debSame",
                           0, 0, 0, 0, "NaN", 2, 12.3, 12.3, 12.3, 0, "", "", "NaN",
                           0, 0.992383612541845, 0.512103336707757, 20, "debSame", 0, 0,
                           0, 0, "NaN", 3, 12.3, 12.3, 12.3, 0, "", "", "NaN", 0,
                           0.992383612541845, 0.512103336707757, 20, "debSame", 0, 0, 0,
                           0, "NaN", 4, 12.3, 12.3, 12.3, 0, "", "", "NaN", 0, 0.992383612541845,
                           0.512103336707757, 20, "debSame", 0, 0, 0, 0, "NaN", 5, 12.3,
                           12.3, 12.3, 0, "", "", "NaN", 0, 0.992383612541845, 0.512103336707757,
                           20, "debSame"))
